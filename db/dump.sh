...
date
echo Concat files
cat /data/bie-staging/biocache/tmp/header.txt /data/bie-staging/biocache/tmp/file.out.* > /data/bie-staging/biocache/occurrences-tmp.csv
date

echo "Fixing escaping of quotes..."
date
