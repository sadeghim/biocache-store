...
$(document).ready(function() {
    ...
    for (var i in sections) {
        ...
        var newRow = "<tr id='comment-"+section+"' class='comments'><th>Comments</td><td class='annoText'>"+
                     "</th><td class='value'>[<span id='"+section+"CommentCount'>0</span> <span id='"+section+
...
function registerFormLink(link) {
    ...
    $(".boxes").modal({
        containerId: "simplemodal-container-ala",
        overlayId: "mask",
        close: false
    });
    //transition effect
