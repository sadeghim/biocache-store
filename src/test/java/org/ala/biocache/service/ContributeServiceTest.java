...
public class ContributeServiceTest extends TestCase {
	...
	public void testRecordSighting(){
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext(new String[]{"classpath*:applicationContext-webapp.xml"});
		ContributeService cs = ctx.getBean(ContributeService.class);
